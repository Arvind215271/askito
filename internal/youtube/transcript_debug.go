...
import (
	...
	transcript_parser "github.com/Arvind215271/askito/internal/youtube/transcript_parser"
)
...
func DebugTranscript(
	...
	vttTranscript, err := GetTranscript(ctx, videoID)
	if err != nil {
		logger.Error(
	...
	jsonTranscript, err := GetTranscriptJSON(ctx, videoID)
	if err != nil {
		logger.Error(
